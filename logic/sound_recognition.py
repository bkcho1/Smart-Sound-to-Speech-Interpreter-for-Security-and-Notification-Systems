...
from config import DEFAULT_FS, DEFAULT_WINDOW_SIZE, DEFAULT_OVERLAP_RATIO, CONNECTIVITY_MASK, PEAK_NEIGHBORHOOD_SIZE, DEFAULT_AMP_MIN, MIN_HASH_TIME_DELTA, MAX_HASH_TIME_DELTA, FINGERPRINT_REDUCTION, DEFAULT_FAN_VALUE

def fingerprint(channels):
    channel_samples = channels[:,1]
